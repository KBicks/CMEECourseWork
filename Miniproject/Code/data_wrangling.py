...
averaged = pd.concat([predator,pred_meanmass,prey_meanmass,feeding_interaction,habitat,depth_mean,temp_mean],axis=1, ignore_index=True)

# assign column names
averaged.columns = ['pred_species','pred_meanmass','prey_meanmass','feeding_interaction','habitat','depth_mean','temp_mean']
